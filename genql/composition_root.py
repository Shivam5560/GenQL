...
class Container(OptimizerContainer):
    ...
    _step_service_providers: dict[str, providers.Provider[Any]] = {
        "catalog_scan": OptimizerContainer.catalog_scan_service,
        "data_profiling": OptimizerContainer.profiling_service,
        "graph_projection": OptimizerContainer.graph_projection_service,
        "object_profiling": OptimizerContainer.object_profiling_service,
        "synthetic_ambiguity_log": OptimizerContainer.synthetic_ambiguity_log_service,
    }

    discovery_runner = providers.Factory(
        DiscoveryRunner,
        steps=providers.List(*_step_providers_in_registered_order(_step_service_providers)),
        registrations=OptimizerContainer.schema_registration_repository,
    )
