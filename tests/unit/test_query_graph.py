...
retriever is involved. Four paths matter: clean, exactly one retry, a second
failure that stops rather than looping, and an unrepairable violation that
never spends the retry at all."""
...
def _graph(
    ...
    graph = build_query_graph(
        ...
        static_validation=ValidateNode(failures, violations),
