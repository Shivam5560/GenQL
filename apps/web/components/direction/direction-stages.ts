...
export const DIRECTION_STAGES: DirectionStage[] = [
  ...
  },
  {
    ...
    status: "DONE",
    summary:
      "When two candidates disagree, AuraSQL runs a bounded sample to see whether the disagreement is real. It was: 6 rows against 4.",
  ...
  },
  {
    ...
    note: "Read-only by construction, not by policy. The role AuraSQL connects with has no write grants.",
    detail: [
      ["role", "aurasql_readonly"],
      ["rows returned", "5"],
      ["row cap", "10 000"],
      ["timeout", "30 s"],
      ["wall time", "41 ms"],
